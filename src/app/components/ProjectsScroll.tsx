...
return (
  <section ref={sectionRef} className="relative w-full snap-none md:snap-start">
    <div className="flex flex-col">
        ...
        >
          ...
          <div
            ...
            style={{
              ...
              transform: scrollActive ? `translateZ(-${radius}px)` : undefined,
            }}
          >
            {!scrollActive && (
      ...
      {/* cards - each card contributes real page height */}
      <div className="flex flex-col">
        {projects.map((project, index) => (
          <div
            key={project.name}
            ...
            className="snap-none md:snap-center w-full min-h-[100svh] flex items-center justify-center px-6 py-8"
          >
            <motion.div
              className="w-full max-w-4xl gap-5 p-5 md:p-10 overflow-hidden flex flex-col md:flex-row"
              animate={{
                  ...
                  {project.techStack && (
                    <div className="flex flex-wrap gap-1 mb-4 text-xs text-neutral-850">
                      {project.techStack.databases.map((tag: string) => (
                        <span key={tag} className="px-2 py-1 rounded-full shadow-inner bg-neutral-100">
                          {tag}
                        </span>
                      ))}
