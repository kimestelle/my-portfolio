export default function OnTastePage() {
  return (
    <div className="blog-formatting max-w-2xl">
      ...
      <p>some places where my taste lives:</p>
      <ul className="list-disc pl-6 space-y-4">
        <li>
          <strong>my room:</strong> i&apos;m not much of a maximalist, but what i keep means a lot. a green box of small gifts from people i love. a shelf of handwritten letters and precious moments figurines. a small collection of red images i sneaked off the design building printer. a fluffy miffy chair i had shipped from japan after my first work-study paycheck. i make sure everything in my room feels like home.
        </li>
        <li>
          <strong>my clothes:</strong> i would buy the $300 shirt. an instagram cartoon artist i follow once said the best clothing choices are the ones you feel most comfortable in, and i think about that a lot. i don&apos;t shop often, but i&apos;m always on the lookout for clothes that make my senses comfortable. quality fabrics, careful design, a pop of red here and there.
        </li>
        <li>
          <strong>my code:</strong> what is a programmer in the age of ai without taste (my own opinion)? claude code is my second brain, but the logic in the end result should be the beautiful, minimal system i can picture in my mind as a living process.
        </li>
        <li>
          <strong>my algorithm:</strong> i try to consume media intentionally, so my algorithm reflects my taste and curates content that bridges and expands my interests. my follower-to-following ratio is terrible, but i love scrolling my explore page.
        </li>
        <li>
