export default function MagnetPoetryPage() {
  return (
    <div className="blog-formatting responsive-padding">
      ...
      <hr className="my-4" />
      <p>
        something I made for fun, documentation in progress...
      </p>
      <p>
        check it out here :-) <a href="https://magnetic-poetry.vercel.app/" className="text-blue-500 hover:underline">magnetic-poetry.vercel.app</a>
      </p>
    </div>
  );
}