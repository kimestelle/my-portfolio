...
export const INTERACTION_STUDIES: InteractionStudy[] = [
  ...
  },
  {
    ...
    dateTime: '2026-08',
    explores:
      'One non-interactive WebGL overlay tracks every target’s bounds, clipping, and corner radius.',
    technical:
  ...
  },
  {
    ...
    dateTime: '2026-07',
    explores:
      'A Hume voice agent delivers route cues; each cue materializes as an interactive journey artifact.',
    technical:
    ...
    videoFit: 'contain',
    recognition: 'SF Make-a-thon · Best Design + Best Use of CopilotKit',
  ...
  },
  {
    ...
    dateTime: '2025-07',
    explores:
      'Drag state stays local; WebSockets broadcast only the word that changed.',
    technical:
  ...
  },
  {
    ...
    dateTime: '2026-06',
    explores:
      'Depth Anything runs in a worker; WebGL displaces the image from the generated depth map.',
    technical:
  ...
  },
  {
    ...
    dateTime: '2026-05',
    explores:
      'Radial distance and layered noise drive the hole, char edge, and embers from the click point.',
    technical:
  ...
  },
  {
    ...
    dateTime: '2025-11',
    explores:
      'D3 forces pack grammar-tagged words into sentence and paragraph bounds without collisions.',
    technical:
  ...
  },
  {
    ...
    dateTime: '2025-09',
    explores:
      'A spring-deformed 2D profile is revolved into a 3D mesh; normals update with the deformation.',
    technical:
